...
urlpatterns = [
    ...
    path(
        "alumnos/home/",
        RedirectView.as_view(pattern_name="sii_home", permanent=False),
        name="alumnos_home",
    ),
    path(
        "alumnos/kardex/",
        RedirectView.as_view(pattern_name="sii_kardex", permanent=False),
        name="kardex",
    ),
    path(
        "alumnos/alumnos/",
        RedirectView.as_view(pattern_name="sii_alumnos", permanent=False),
        name="alumnos",
    ),
    path(
        "alumnos/horario/",
        RedirectView.as_view(pattern_name="sii_horario", permanent=False),
        name="horario",
    ),
    path(
        "alumnos/pagos/",
        RedirectView.as_view(pattern_name="Pagos", permanent=False),
        name="pagos",
    ),
    path("docente/", RedirectView.as_view(url="/sii/docentes/", permanent=False)),
    path("administrador/", RedirectView.as_view(url="/sii/", permanent=False)),
