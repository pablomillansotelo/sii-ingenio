...
urlpatterns = [
    ...
    path("kardex/", RedirectView.as_view(pattern_name="aula_kardex", permanent=False), name="kardex"),
    path("alumnos/", RedirectView.as_view(pattern_name="sii_alumnos", permanent=False), name="alumnos"),
    path("horario/", RedirectView.as_view(pattern_name="aula_dashboard", permanent=False), name="horario"),
