...
FEATURES = {
    ...
    "sii.horario.write": {"roles": {ADMIN}, "scopes": {ADMIN: "all"}},
    "aula.cursos": {
        "roles": {ADMIN, DOCENTE, ALUMNO},
        "scopes": {ADMIN: "all", DOCENTE: "assigned", ALUMNO: "own"},
    },
...
URL_FEATURES = {
    ...
    "sii_mi_ficha": "sii.alumnos",
    "sii_alumno_ficha": "sii.alumnos",
    "sii_alumno_reset_cuenta": "sii.alumnos.write",
    "sii_actas": "sii.actas",
    "sii_acta_detalle": "sii.actas",
    "sii_acta_publicar": "sii.actas.final.write",
    "sii_periodo_cerrar": "sii.periodos.write",
    "sii_horario": "sii.horario",
    "sii_horario_crear": "sii.horario.write",
    "sii_horario_quitar": "sii.horario.write",
    ...
    "aula_guardar_calificaciones": "aula.calificar",
    "aula_por_calificar": "aula.calificar",
...
NAV = {
    ...
    "sii": [
        ...
        {"label": "Actas", "url_name": "sii_actas", "icon": "bi-file-earmark-check", "feature": "sii.actas"},
        {"label": "Horario", "url_name": "sii_horario", "icon": "bi-clock", "feature": "sii.horario"},
    ],
    "aula": [
        {"label": "Mis cursos", "url_name": "aula_dashboard", "icon": "bi-grid", "feature": "aula.cursos"},
        {
            "label": "Por calificar",
            "url_name": "aula_por_calificar",
            "icon": "bi-pencil-square",
            "feature": "aula.calificar",
            "badge": "calificar",
        },
    ],
}
...
def visible_en_menu(user, item):
    ...
    if nav_roles:
        ...
        if user.is_superuser:
            if nav_roles <= {ALUMNO}:
                return False
        elif not (roles_inferidos(user) & nav_roles):
            return False
    return True
